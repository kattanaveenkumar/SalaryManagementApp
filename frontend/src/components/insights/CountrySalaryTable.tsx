...
export default function CountrySalaryTable({ data }: Props) {
  return (
    <div>
      <h2 className="text-base font-semibold text-gray-900 mb-4">Salary by Country</h2>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-200 bg-gray-50">
              ...
              <th className="text-right px-3 py-2.5 font-medium text-gray-600">Min</th>
              <th className="text-right px-3 py-2.5 font-medium text-gray-600">Avg</th>
              <th className="text-right px-3 py-2.5 font-medium text-gray-600">Max</th>
            </tr>
          </thead>
          <tbody>
            {data.map((row) => (
