...
RSpec.describe "Api::V1::Employees", type: :request do
  ...
  describe "GET /api/v1/employees" do
    ...
    it "filters by country" do
      ...
      get "/api/v1/employees", params: { country: "Japan" }
  ...
  describe "POST /api/v1/employees" do
    let(:valid_params) do
      { employee: { full_name: "New Person", job_title: "Dev", country: "France", salary: 55_000 } }
    end
    ...
    it "creates a new employee record" do
      expect { post "/api/v1/employees", params: valid_params }.to change(Employee, :count).by(1)
    end
    ...
    it "returns 422 when the employee param key is missing" do
      post "/api/v1/employees", params: { name: "oops" }
      expect(response).to have_http_status(:unprocessable_entity)
    end
  end
  ...
  describe "PATCH /api/v1/employees/:id" do
    ...
    it "returns 200 OK on success" do
      patch "/api/v1/employees/#{employee.id}", params: { employee: { salary: 70_000 } }
      expect(response).to have_http_status(:ok)
    end
    ...
    it "returns 404 for a non-existent employee" do
      patch "/api/v1/employees/0", params: { employee: { salary: 70_000 } }
      expect(response).to have_http_status(:not_found)
    end
  end
